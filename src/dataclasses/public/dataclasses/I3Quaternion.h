/**
 *  $Id: I3Quaternion.h 133146 2015-05-31 13:27:56Z boersma $
 *  
 ...
 *
 * @version $Id: I3Quaternion.h 133146 2015-05-31 13:27:56Z boersma $
 */
...
class I3Quaternion : public I3FrameObject
	...
	public:
		...
		/**
		 * The stream operator. Makes it easy to print out the
		 * quaternion to an ostream as text.
		 */
		friend inline std::ostream& operator<<(std::ostream& output, const I3Quaternion& q)
		{
			output << "[(" << q.x_ << ", " << q.y_ << ", " << q.z_ << "), " << q.w_ << "]";
			return output; 
		}
