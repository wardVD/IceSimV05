...
if __name__ == "__main__":
    ...
    parser.defaults["outputfile"] = os.path.join(tmpdir,"nugen_numu_fullchain.i3.gz")
    parser.defaults["summaryfile"] = os.path.join(tmpdir,"nugen_numu_fullchain.xml")
    parser.defaults['mjd'] = 56429
    parser.defaults['nuflavor']='NuMu'
    parser.defaults['gamma']=1.0
    parser.defaults['histogramfilename'] = "nugen_numu.pkl"
    ...
    parser.defaults['inputfilelist'] = [os.path.join(tmpdir,"nugen_numu_fullchain.i3.gz")]
    ...
    parser.defaults["outputfile"] = os.path.join(tmpdir,"nugen_numu_photons_fullchain.i3.gz")
    parser.defaults["summaryfile"] = os.path.join(tmpdir,"nugen_numu_photons_fullchain.xml")
    parser.defaults['histogramfilename'] = "nugen_numu_pes.pkl"
    clsim.ExecuteOpts(stats)

    stats = {}
    detsim = icecube.simprod.modules.IC86()
    parser = detsim._opt_parser
    parser.defaults['inputfile'] = os.path.join(tmpdir,"nugen_numu_photons_fullchain.i3.gz")
    parser.defaults['gcdfile'] = os.path.expandvars("$I3_TESTDATA/sim/GeoCalibDetectorStatus_2013.56429_V1.i3.gz")
    parser.defaults['runid'] = 12345
    parser.defaults['histogramfilename'] = "nugen_numu_trigger.pkl"
