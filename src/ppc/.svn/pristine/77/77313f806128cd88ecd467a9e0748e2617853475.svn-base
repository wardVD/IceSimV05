...
// hide warnings from deprecated APIs
...
#undef SHRT
  ...
  struct gpu{
	...
	clBuildProgram(program, 1, &devID, dtype==CL_DEVICE_TYPE_GPU?"-cl-fast-relaxed-math":"", NULL, NULL);
	...
	if(dtype==CL_DEVICE_TYPE_ACCELERATOR) nthr=1;  // necessary on Intel Phi
