...
void Propagate::interpolate(string w)
{
    ...
    plog_debug("Parameterizations apply in the energy range from "<<e_low<<" MeV to "<<e_hi<<" MeV");
    ...
    try
    {
        ...
        plog_info("Finished parameterizations");
    }
    catch(int a)
    {
        throw 0;
