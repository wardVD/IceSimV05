...
class EarthModelService : public I3ServiceBase
{
 ...
 public:
   ...
   const double IntegrateDensityInCGS(
                    ...
                    IntegType intg_type = PATH) const;
    ...
    *              not of interest
    */
   double DistanceToNextBoundaryCrossing(const I3Position& posCE,
    ...
    */
   const I3Position & GetDetectorPosInEarthCoord() const {return fDetPos_;}
 ...
 private:
    ...
    */
   const double FlatDepthCalculator(const I3Position &frompos_CE,
                                    const I3Position &topos_CE,
                                    double density,
   ...
   I3Position fDetPos_;   // position of I3 origin in Earth-centered coordinate
   ...
   struct densityPathIntegrand {
      ...
      densityPathIntegrand(const EarthParam& e, const I3Position& p, const I3Direction& d, IntegType integ_type):
