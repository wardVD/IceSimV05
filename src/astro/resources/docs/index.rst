...
.. 
.. $Id: index.rst 142880 2016-03-08 19:09:44Z nega $
..
...
converting between coordinate systems, `I3Direction` from dataclasses is used for storing local
...
Positional astronomy calculations can be extremely accurate, standard software such as SLALIB
and PAL can achieve milliarcsecond precision when all of the corrections are applied correctly.
...
Astronomical calculation are done using either SLALIB and PAL.
`SLALIB <http://star-www.rl.ac.uk/docs/sun67.htx/sun67.html>`_ is an old Fortran library which
was translated into c, it is no longer updated, has a weird license, and is hard to find.
...
You only need to get one of these two libraries working.

PAL is the perfered option, instructions for downloading it can be found in the `cmake tools documentaion <../cmake/tools/pal.html>`_.
SLALIB can be installed throught the `I3_PORTS system <../cmake/ports.html>`_.


See Also
========
  
`Doxygen Documentation <../../doxygen/astro/index.html>`_
