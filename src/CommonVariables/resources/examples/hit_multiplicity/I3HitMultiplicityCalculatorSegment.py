# $Id: I3HitMultiplicityCalculatorSegment.py 129313 2015-02-20 16:22:31Z olivas $
#
# Copyright (C) 2012
...
common_variables.hit_multiplicity.I3HitMultiplicityCalculatorSegment icetray
traysegment.
...
def main():
    ...
    hdf_filename = os.path.join(
        ...
        'hit_multiplicity', 'I3HitMultiplicityCalculatorSegment_data.hdf'
    )
