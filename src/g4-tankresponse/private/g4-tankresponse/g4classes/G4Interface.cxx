 ...
 * ID: $Id: G4Interface.cxx 121696 2014-07-17 21:03:56Z jgonzalez $
 *
 * @file G4Interface.cxx
 * @version $Rev: 121696 $
 * @date $Date: 2014-07-17 16:03:56 -0500 (Thu, 17 Jul 2014) $
...
#include <g4-tankresponse/g4classes/G4IceTopUserTrackingAction.h>
...
void G4Interface::InstallTank(G4IceTopTank* tank)
{
  ...
  if(!detector_) detector_ = new G4IceTopDetectorConstruction();
...
void G4Interface::Initialize()
{
  ...
  runManager_.SetUserAction(new G4IceTopUserSteppingAction());
