 ...
 * ID: $Id: G4IceTopRunManager.cxx 86084 2012-03-08 01:54:18Z claudio.kopper $
 *
 * @file G4IceTopRunManager.cxx
 * @version $Rev: 86084 $
 * @date $Date: 2012-03-07 19:54:18 -0600 (Wed, 07 Mar 2012) $
...
G4IceTopRunManager::G4IceTopRunManager(): G4RunManager()
{
  
}


void G4IceTopRunManager::BeamOn(G4int n_event,const char* macroFile,G4int n_select)
{
  G4String text = "BeamOn method is not supported in G4IceTopRunManager!";
  G4Exception("G4IceTopRunManager::BeamOn()", "G4IceTopRunManager001", FatalException, text);
}


void G4IceTopRunManager::InitializeRun()
{
...
void G4IceTopRunManager::InjectParticle(G4ParticleGun* particleGun)
{
  if(!currentRun)
  {
    G4String text = "Run needs to be initialized before injecting a particle.";
    G4Exception("G4IceTopRunManager::InjectParticle()", "G4IceTopRunManager002", FatalException, text);
  }
...
G4Event* G4IceTopRunManager::GenerateEvent(G4int i_event)
{
...
void G4IceTopRunManager::TerminateRun()
{
  if(verboseLevel>0)
  {
    timer->Stop();
...
void G4IceTopRunManager::Update_Scoring()
{
