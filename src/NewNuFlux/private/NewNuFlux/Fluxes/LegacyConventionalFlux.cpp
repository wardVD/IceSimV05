...
namespace NewNuFlux{
	LegacyConventionalFlux::component readConvComponent(const std::string& path){
	...
	PionKaonAdjustable(1.0,1.0){
		...
		components[I3Particle::NuMu]=readConvComponent(dir+"/"+fluxName+"_numu.dat");
		components[I3Particle::NuMuBar]=readConvComponent(dir+"/"+fluxName+"_numubar.dat");
		components[I3Particle::NuE]=readConvComponent(dir+"/"+fluxName+"_nue.dat");
		components[I3Particle::NuEBar]=readConvComponent(dir+"/"+fluxName+"_nuebar.dat");
